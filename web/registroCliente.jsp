...
<body>
    ...
    <form class="login" action="index.jsp">
        ...
        <h1 class="login-title">Registro Cliente</h1>
        Nombre:*
        <input required="" type="text" class="login-input" placeholder="nombre" autofocus>
        Apellido:*
        <input required="" type="text" class="login-input" placeholder="apellido" autofocus>
        Dirección:*
        <input required="" type="text" class="login-input" placeholder="dirección" autofocus>
        Fono:*
        <input required="" type="text" class="login-input" placeholder="09-123456780" autofocus>
        e-mail:*
        <input required="" type="text" class="login-input" placeholder="qwerty@masterbike.cl" autofocus>
        Clave:*
        <input required="" type="text" class="login-input" placeholder="clave" autofocus>
        Repita clave:*
        <input required="" type="text" class="login-input" placeholder="repita clave" autofocus>
        &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
        &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
        <input class="btn btn-warning" type="submit" aling="center" value="Registrar"/>
  </form>
